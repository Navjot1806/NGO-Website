  ...
  <body>
    ...
    <section class="text-center pt-5 pt-lg-0" id="home">
            <div class="carousel-item drk active">
              <img class="d-block w-100 bg-transparent" src="images/plant-trees1.jpg" alt="Second slide">
    ...
    <section class="py-5">
      <div class="container py-5">
        <div class="row mb-5">
          <div class="col-lg-6">
            <p class="drop-caps py-3"> Tree plantation is one of the effective remedial measures to control the air pollution and noise pollution. 
                It also causes aesthetics improvement of the area as well as sustains and supports the biosphere.</p>
            <p class="py-3">
            Globally, forest cover is one-third less than what it once was and global deforestation continues at 18 million hectares per year. 
            This indiscriminate felling of trees, needs to be undertaken on a large scale to reverse the ill effects of deforestation and 
            restore the ecological balance.</p>
            
          </div>
          <div class="col-lg-6"><img class="img-fluid" src="images/tree_plantation.jpg" alt=""></div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <p class="py-3"> Our ngo runs tree plantation campaigns across its projects on a annual basis. 
            The campaigns are community-owned and managed and always implemented alongside environmental education and awareness, 
            to promote environmental stewardship, encouraging a sense of responsibility of the planted trees.</p>
          </div>
        </div>
        <div class="row mb-5">
          <div class="col-lg-6"><img class="img-fluid" src="images/tree_plantation3.jpg" alt=""></div>
          <div class="col-lg-6">
            <p class="py-3"> In 2014-16, close to 1 million trees were planted by around 200,000 people, across 62 projects in 6 states of India. 
            Alongside, environmental education was provided to 180,000 children, teachers and community members. 
            This special action indicated a lasting tradition of promoting tree plantation in the projects in cooperation with local communities, 
            government forest offices, and government and state run educational institutes.</p>
            <p class="py-3">
            In 2019-20, nearly 161,139 saplings were planted across the country, while more than 60,000 individuals were 
            reached with climate literacy and awareness activities.</p>
          </div>
        </div>
      </div>
    </section>
